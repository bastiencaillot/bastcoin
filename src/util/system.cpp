...
const char * const BITCOIN_CONF_FILENAME = "bastcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bastcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bastcoin";
#else
    // Unix
    return pathRet / ".bastcoin";
#endif
#endif
}
