...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bastcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bastcoin-tx [options] <hex-tx> [commands]  Update hex-encoded bastcoin transaction\n" +
            "or:     bastcoin-tx [options] -create [commands]   Create hex-encoded bastcoin transaction\n" +
            "\n";
