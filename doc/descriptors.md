# Support for Output Descriptors in Bastcoin Core

There is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `bas1...` for mainnet or `tbas1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Bastcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Bastcoin Core wallets, a convenience function `combo` is
