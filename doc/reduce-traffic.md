...
By default, Bastcoin Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that bastcoin's trustless model works best if you are
