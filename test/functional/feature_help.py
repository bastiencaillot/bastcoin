...
"""Verify that starting bastcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bastcoin with -h for help text")
        ...
        self.log.info("Start bastcoin with -version for version information")
        ...
        self.log.info("Start bastcoind with -fakearg to make sure it does not start")
