...
"""Bastcoin P2P network half-a-node.
...
MAGIC_BYTES = {
    "mainnet": b"\x92\x59\xf0\x6b",   # mainnet
    "testnet3": b"\x79\x17\xa2\x93",  # testnet3
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_connect(self, dstaddr, dstport, net="regtest"):
        ...
        logger.debug('Connecting to Bastcoin Node: %s:%d' % (self.dstaddr, self.dstport))
...
class P2PInterface(P2PConnection):
    """A high-level P2P interface class for communicating with a Bastcoin node.
